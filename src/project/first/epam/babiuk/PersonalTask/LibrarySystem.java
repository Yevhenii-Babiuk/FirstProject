...
public class LibrarySystem {
    public static void main(String[] args) {
        ...
        order.setOrder(1111, alphabet, client0, LocalDate.of(2019, 3, 5), LocalDate.of(2019, 4, 5), false);
        order.setOrder(1112, alphabet, client1, LocalDate.of(2019, 3, 2), LocalDate.of(2019, 4, 10), false);

        System.out.println("Available of "+alphabet.getName()+" is "+alphabet.getAvailableNumber());

        control.setStatusBack(1111);


        control.printAllOrders();
        ...
        control.searchBooksByClient("Pavlov");
    }
}
